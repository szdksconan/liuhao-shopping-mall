...
public class CategoryController {
    ...
    @GetMapping
    public Resp<List<CategoryEntity>> queryCategoryByPidOrLv(
            @RequestParam(value = "level",defaultValue = "0") Integer level,@RequestParam(value = "parentCid",required = false)Long pid){
